...
const StartupDetailPage = () => {
  ...
  return (
    <ImageBackground style={styles.background}>
      ...
      <View style={[styles.containerHaut1]}>
        <TouchableOpacity>
          <View style={styles.containeIcon1}>
            ...
            <Text style={{ color: 'white' }}>Business Plan</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity>
          <View style={styles.containeIcon1}>
            <FontAwesome name="dollar" size={40} color={Colors.white} />
            <Text style={{ color: 'white' }}>Pitch Deck</Text>
          </View>
        </TouchableOpacity>
        <TouchableOpacity>
          <View style={styles.containeIcon1}>
            <FontAwesome name="pie-chart" size={40} color={Colors.white} />
            <Text style={{ color: 'white' }}>Rapport Financier</Text>
          </View>
        </TouchableOpacity>
      </View>
      ...
      /> */}
         <View style={styles.containerHaut2}>
        <View style={styles.statsContainer}>
          <Text style={styles.statsText}>Total Startups: {totalStartups}</Text>
          <Text style={styles.statsText}>Average Rating: {averageRating.toFixed(1)}</Text>
        </View>
